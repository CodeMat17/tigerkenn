...
const TopicsPage = () => {
  ...
  console.log("fetchAdmin: ", isAdmin);
      ...
      <div className='max-w-6xl mx-auto px-4 py-8 flex flex-col lg:flex-row gap-8'>
        <div className='flex-1'>
          <div className='flex items-cent justify-between mb-4 gap-4'>
            <div>
              <h2 className='text-2xl'>Forum Posts</h2>
          ...
          {sortedTopics && sortedTopics.length < 1 ? (
            ...
            sortedTopics.map((topic) => (
              <div
                key={topic.id}
                className='shadow-md border dark:border-none rounded-xl overflow-hidden mb-3'>
                ...
                <div className='flex items-center pr-4 justify-between bg-gray-50 dark:bg-gray-700 text-gray-500 dark:text-gray-400 text-sm'>
                  <Button
                    variant='ghost'
                    onClick={() => {
                      if (navigator.share) {
